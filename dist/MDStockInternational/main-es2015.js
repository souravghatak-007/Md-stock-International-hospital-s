...
/* harmony import */ var ngx_moment__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ngx-moment */ "./node_modules/ngx-moment/fesm2015/ngx-moment.js");
...
let HomeComponent = class HomeComponent {
    ...
    constructor(apiService, router, activatedroute, meta, formBuilder, http, modalService, cookieservice) {
        ...
        this.apiService.postData('userid', undefined).subscribe((response) => {
        ...
        this.date = moment__WEBPACK_IMPORTED_MODULE_9__(this.myDate).format('MM/DD/YYYY');
        this.signUpform = this.formBuilder.group({
            ...
            email: ['', [_angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].pattern(/^\s*[\w\-\+_]+(\.[\w\-\+_]+)*\@[\w\-\+_]+\.[\w\-\+_]+(\.[\w\-\+_]+)*\s*$/)]],
    ...
    ngOnInit() {
        ...
        this.apiService.postData('datalist', data).subscribe((res) => {
            //console.log(res.res);
...
module.exports = __webpack_require__(/*! /home/influxiq-03/Downloads/Md-stock-International-hospital-s/src/main.ts */"./src/main.ts");
